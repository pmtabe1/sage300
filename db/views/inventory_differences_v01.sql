SELECT
  ...
  CASE 
    WHEN
    SUM(GraniteDR.dbo.App_Inventory_ByLocation.Qty) IS NULL THEN 0.00
    ELSE SUM(GraniteDR.dbo.App_Inventory_ByLocation.Qty)
  END AS QTYGRANIT,
...
FROM dbo.ICILOC
FULL OUTER JOIN
  GraniteDR.dbo.App_Inventory_ByLocation ON dbo.ICILOC.ITEMNO COLLATE DATABASE_DEFAULT = GraniteDR.dbo.App_Inventory_ByLocation.Code COLLATE DATABASE_DEFAULT AND
  dbo.ICILOC.LOCATION COLLATE DATABASE_DEFAULT = GraniteDR.dbo.App_Inventory_ByLocation.ERPLocation COLLATE DATABASE_DEFAULT
