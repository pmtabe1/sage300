class CreateTableItemsCustomersSalesTrend < ActiveRecord::Migration[5.1]
  def change
    create_table :items_customers_sales_trends do |t|
      t.string :customer
      t.string :sales_rep
      t.string :item
      t.string :opt_field_cat
      t.string :opt_field_product
      ...
      t.decimal :ytd_diff_netsales, precision: 19, scale: 6
      ...
      t.decimal :ytd_diff_margin, precision: 19, scale: 6
